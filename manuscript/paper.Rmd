...
variables. Sleep duration on workdays was also recorded and was
categorized into three groups, that is, \< 6 h, 6--8 h, ≥ 8 h
respectively, and used \< 6 h as the reference group in our analysis.
Table \@ref{tab:tabone} highlights the variable names and descriptions
